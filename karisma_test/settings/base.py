...
SECRET_KEY = 'django-insecure-x=8^j7sx3yzr%p=_ma&)kbwlg=*ono%hg*#g^bg4^%rwx(2m9@'
...
ROOT_URLCONF = 'karisma_test.urls'
...
WSGI_APPLICATION = 'karisma_test.wsgi.application'
